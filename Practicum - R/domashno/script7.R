...
#   или резултат, която искаме да прогнозираме.
...
#   описва добре данни и какви са оценките на коефициентите му.
summary(model1)
...
#   цялата графика. Между двете червени линии хипотетично се намират 95% от остатъците.
...
#   на Durbin-Watson. Този тест се намира в пакета "lmtest", който трябва да инсталираме и
#   заредим. 
